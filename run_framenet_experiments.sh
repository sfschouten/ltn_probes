...
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=0 --log_neptune --write_metrics --metrics_file=metrics_openllama_0_shuffled.csv --shuffled_baseline
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=4 --log_neptune --write_metrics --metrics_file=metrics_openllama_4_shuffled.csv --shuffled_baseline
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=8 --log_neptune --write_metrics --metrics_file=metrics_openllama_8_shuffled.csv --shuffled_baseline
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=12 --log_neptune --write_metrics --metrics_file=metrics_openllama_12_shuffled.csv --shuffled_baseline
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=16 --log_neptune --write_metrics --metrics_file=metrics_openllama_16_shuffled.csv --shuffled_baseline
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=20 --log_neptune --write_metrics --metrics_file=metrics_openllama_20_shuffled.csv --shuffled_baseline
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=24 --log_neptune --write_metrics --metrics_file=metrics_openllama_24_shuffled.csv --shuffled_baseline

# probing
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=0 --log_neptune --write_metrics --metrics_file=metrics_openllama_0.csv
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=4 --log_neptune --write_metrics --metrics_file=metrics_openllama_4.csv
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=8 --log_neptune --write_metrics --metrics_file=metrics_openllama_8.csv
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=12 --log_neptune --write_metrics --metrics_file=metrics_openllama_12.csv
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=16 --log_neptune --write_metrics --metrics_file=metrics_openllama_16.csv
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=20 --log_neptune --write_metrics --metrics_file=metrics_openllama_20.csv
python evaluate_fn.py --model=TheBloke/open-llama-7b-open-instruct-GPTQ --dataset=framenet --layer=24 --log_neptune --write_metrics --metrics_file=metrics_openllama_24.csv
